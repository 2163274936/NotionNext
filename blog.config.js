...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '维利翁', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '努力成为一名懂得感恩的好孩子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://villion.top', // 网站地址
